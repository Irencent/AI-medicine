...
if __name__ == '__main__':
    ...
    parser.add_argument('--radiomics_file', # 大数据集的radiomics特征路径：cohort1, cohort2, cohort3
                        default='/Users/wangpengcheng/Documents/MB_AI/new_3cls_radiomics_new.txt')
    parser.add_argument('--radiomics_file_c4', # 黄金验证数据集的radiomics特征路径：cohort4
                        default='/Users/wangpengcheng/Documents/MB_AI/new_3cls_radiomics_cohort4_new.txt')
    ...
    parser.add_argument('--csv_result', # 保存关键指标的csv文件路径
                        default='/Users/wangpengcheng/Downloads/MB_LGBM_CLNC_FINAL_3CLS_ANLS/results.csv')
    parser.add_argument('--print', default=False) # 运行时是否打印详细信息
